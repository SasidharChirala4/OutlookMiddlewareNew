...
namespace Edreams.OutlookMiddleware.DataAccess.Migrations.OutlookMiddlewareDb
{
    ...
    [Migration("20210122130539_Rename_Transactions_To_TransactionQueue")]
    partial class Rename_Transactions_To_TransactionQueue
    {
            ...
            modelBuilder.Entity("Edreams.OutlookMiddleware.Model.CategorizationRequest", b =>
                {
                    ...
                    b.Property<int>("CategorizationRequestType")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserPrincipalName", "Sent", "CategorizationRequestType", "InternetMessageId");
