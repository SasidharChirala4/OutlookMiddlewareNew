...
{
    [Cmdlet(VerbsData.Publish, "EdreamsOutlookMiddlewarePreloadDatabase")]
    public class PublishOutlookMiddlewarePreloadDatabaseCommand : Cmdlet
    {
        ...
        public PublishOutlookMiddlewarePreloadDatabaseCommand()
        {
        ...
        {
            using (var dbContext = new OutlookMiddlewarePreloadDbContext(ConnectionString))
            {
        ...
        private Assembly CurrentDomain_AssemblyResolve(object sender, ResolveEventArgs args)
        {
            ...
            foreach (KeyValuePair<string, string> assemblyRedirect in _assemblyRedirects)
            {
                ...
                {
                    Assembly currentAssembly = Assembly.GetAssembly(typeof(PublishOutlookMiddlewarePreloadDatabaseCommand));
